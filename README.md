# boxkit &nbsp; [![boxkit build badge](https://github.com/ryan-j-walker/boxkit/actions/workflows/build-boxkit.yml/badge.svg)](https://github.com/ryan-j-walker/boxkit/actions/workflows/build-boxkit.yml)
